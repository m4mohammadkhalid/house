...
const Footer = () => {
    return (
            ...
            <div className="col-lg-4 col-md-8 col-sm-12">
              <aside id="text-1" className="widget widget_text widget_custom_html">
                <div className="textwidget custom-html-widget">
                  ...
                  <p>Code Sparrow we understand that people everywhere are searching for a home to
        ...
        <div className="copyright">
          <div className="container">
            <div className="row">
              <div className="col-md-6"><span>Copyright © 2020 Code Sparrow</span> ⋅ <span>Tel: +91 9102603030</span></div>
              <ul className="social">
