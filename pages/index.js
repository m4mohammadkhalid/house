              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="listicle-box">
                  <figure>
                    ...
                    <a href="#" className="zoom-img"><img src="images/property-5.jpg" alt /></a>
                  </figure>
                  <div className="box-content">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="listicle-box">
                  <figure>
                    ...
                    <a href="#" className="zoom-img"><img src="images/property-1.jpg" alt /></a>
                  </figure>
                  <div className="box-content">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="listicle-box">
                  <figure>
                    ...
                    <a href="#" className="zoom-img"><img src="images/property-3.jpg" alt /></a>
                  </figure>
                  <div className="box-content">
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="listicle-box">
                  <figure>
                    ...
                    <a href="#" className="zoom-img"><img src="images/property-6.jpg" alt /></a>
                  </figure>
                  <div className="box-content">
